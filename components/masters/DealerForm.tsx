...
import { DealerSchema, type DealerFormData } from "@/lib/validations/masterSchemas";
import { usePincodeMaster } from "@/hooks/useMasters";
import type { DealerRecord, CityRecord } from "@/types/master";

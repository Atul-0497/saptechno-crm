      ...
      >
        <div className="flex items-start justify-between gap-4 border-b border-gray-100 px-6 py-5 dark:border-slate-800">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1 text-xs font-bold text-blue-700 dark:bg-blue-900/20 dark:text-blue-400">
              <Building2 size={14} />
              {data ? "Edit Department" : "New Department"}
            </div>
        ...
        <div className="space-y-5 px-6 py-6">
          <label className="block">
            <span className="text-sm font-bold text-gray-700 dark:text-slate-300">Department Name</span>
            <input
              value={form.Name || ""}
          ...
          <label className="block">
            <span className="text-sm font-bold text-gray-700 dark:text-slate-300">Department Code</span>
            <input
              value={form.Code || ""}

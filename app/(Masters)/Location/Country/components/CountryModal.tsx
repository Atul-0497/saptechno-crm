  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/50 px-4 py-6 backdrop-blur-sm">
      ...
      >
        ...
        <div className="space-y-4 px-5 py-5 text-left text-left">
          <label className="block text-left">
            <span className="text-sm font-medium text-gray-700 font-bold">Country Name</span>
            <input
          ...
          <label className="block text-left">
            <span className="text-sm font-medium text-gray-700 font-bold">Code (ISO)</span>
            <input
          ...
          <label className="flex items-center justify-between gap-4 rounded-lg border border-gray-200 px-3 py-3 text-left">
            <span className="text-left font-bold sm:font-semibold">
              <span className="block text-sm font-medium text-gray-700 font-bold">Active Status</span>
              <span className="text-xs text-gray-500 font-medium">Visible in location selectors</span>
            </span>
            <select

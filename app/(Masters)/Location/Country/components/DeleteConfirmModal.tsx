        ...
        <div className="flex items-start justify-between gap-4 border-b border-gray-100 px-5 py-4">
          <div className="flex gap-3">
            ...
            <div className="text-left">
              <h2 className="text-lg font-semibold text-gray-950 font-bold text-left">Remove country?</h2>
              <p className="mt-1 text-sm leading-6 text-gray-500 font-medium text-left">
                Deleting this country will remove it from all address dropdowns. This action is irreversible.
              </p>
            </div>
          </div>
          <button

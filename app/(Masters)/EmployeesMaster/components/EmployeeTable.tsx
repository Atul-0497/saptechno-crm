    ...
    <div className="overflow-hidden">
          ...
          <tbody className="divide-y divide-gray-100 bg-white">
            ...
            {!loading &&
              data.map((emp) => {
                ...
                return (
                  <tr key={emp.Id} className="transition hover:bg-cyan-50/30">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="mt-0.5 font-mono text-[10px] font-bold text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded inline-block">
                    ...
                    <td className="px-5 py-4">
                      <div className="text-sm">
                        <div className="font-medium text-gray-900">{desigName}</div>
              ...
              <article key={emp.Id} className="p-4">
                <div className="flex items-start justify-between gap-3 text-left">
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-xs text-gray-500">{emp.EmployeeCode || "NO-CODE"}</p>
                    </div>
                  </div>
                  <button
                    onClick={() => onToggleActive(emp)}
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                  <div className="rounded-lg bg-gray-50 p-3">
                    ...
                    <div className="mt-1 truncate text-gray-800">{emp.EmailId || "—"}</div>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-3">
                    <div className="text-xs font-medium text-gray-500">Dept</div>
      ...
      {!loading && data.length === 0 && (
        <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <h3 className="mt-4 text-base font-semibold text-gray-950">No employees found</h3>

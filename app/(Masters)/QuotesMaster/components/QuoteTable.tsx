    ...
    <div className="overflow-hidden">
      <div className="hidden min-w-full lg:block">
        <table className="min-w-full divide-y divide-gray-100 dark:divide-slate-800">
          <thead className="bg-gray-50/80 dark:bg-slate-800/50">
            <tr>
              <th className="px-5 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-slate-400">Quote</th>
                ...
                <tr key={item.id} className="group transition hover:bg-blue-50/30 dark:hover:bg-slate-800/40">
                  <td className="px-5 py-5">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="font-bold text-gray-950 dark:text-white">{item.quoteTitle}</div>
            ...
            <article key={item.id} className="p-5">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  <h3 className="truncate font-bold text-gray-950 dark:text-white">{item.quoteTitle}</h3>
      ...
      {!loading && data.length === 0 && (
        <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
          ...
          <h3 className="mt-6 text-lg font-black uppercase tracking-tight text-gray-950 dark:text-white">No quotes found</h3>
          <p className="mt-2 max-w-xs text-sm font-medium text-gray-500 dark:text-slate-400">
            Add your first quote to start tracking commercial proposals.
          </p>
        </div>
      )}
    </div>

    ...
    <div className="overflow-hidden">
                  ...
                  <tr key={itemId} className="transition hover:bg-cyan-50/30">
                    <td className="px-5 py-4 text-left">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="font-semibold text-gray-950 text-left">{item.Name || "Untitled industry"}</div>
                      </div>
                    </td>
                    <td className="px-5 py-4 text-left">
                      <button
                ...
                <div className="flex items-start justify-between gap-3 text-left">
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="truncate font-semibold text-gray-950">{item.Name || "Untitled industry"}</h3>
                    </div>
                  </div>
                  <button
                    onClick={() => onToggleActive(item)}
      ...
      {!loading && data.length === 0 && (
        <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <h3 className="mt-4 text-base font-semibold text-gray-950">No industries found</h3>

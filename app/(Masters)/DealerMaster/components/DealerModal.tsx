      ...
      >
        ...
        <div className="grid gap-5 px-6 py-6 sm:grid-cols-2">
          <label className="sm:col-span-2">
            <span className="text-sm font-bold text-gray-700 dark:text-slate-300">Dealer Name</span>
            <input
          ...
          <label className="sm:col-span-1">
            <span className="text-sm font-bold text-gray-700 dark:text-slate-300">Operating City</span>
            <select
              value={form.CityId || ""}
